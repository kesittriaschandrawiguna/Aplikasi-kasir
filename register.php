<?php
    ...
    if(isset($_POST['username'])) {
        ...
        if($insert) {
            ...
            echo '<script>alert("Regiaster gagal");</script>';
        }
    }
?>
<!DOCTYPE html>
                                    ...
                                    <div class="card-body">
                                        <form method="post">
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputEmail" type="username" name="nama" placeholder="Masukan nama lengkap" />
                                                <label for="inputEmail">Nama Lengkap</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputEmail" type="username" name="username" placeholder="Masukan username" />
